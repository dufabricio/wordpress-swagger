...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.mouseEnter = function(e) {
      ...
      elem = jQuery(e.currentTarget.parentNode).find('#api_information_panel');
      x = e.pageX;
      y = e.pageY;
    ...
    OperationView.prototype.toggleOperationContent = function() {
      var elem;
      elem = jQuery('#' + Docs.escapeResourceName(this.model.parentId + "_" + this.model.nickname + "_content"));
      if (elem.is(':visible')) {
